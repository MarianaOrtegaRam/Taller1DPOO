...
public class CalculadoraEstadisticas
{
	...
	/** 
	 * CAMBIOS CALCULADORA PARA MODIFICACIÓN I:
	 * Indica el pais de un atleta en especifico
	 * 
	 * @param nombre Nombre que indica el usuario 
	 * @return retorno mapa con los nombres de atletas como llave,
	 * y su valor asociado es el pais el cual representa
	 */
