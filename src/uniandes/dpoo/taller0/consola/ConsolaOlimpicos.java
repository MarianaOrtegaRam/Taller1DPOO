...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pais de atleta");
	...
	/**
	 * Este método le pide al usuario el nombre de un atleta,y retorna el al usuario
	 * el pais al cual representa el atleta
	 */
	...
	private void ejecutarPaisDeAtleta()
	{
		...
		String nombre = input("Ingrese el atleta que desea conocer su país: ");
		Map<String, String> atletas = calculadora.paisDelAtleta(nombre);
		String nombrePais =atletas.get(nombre);
		System.out.println("El altleta  "+ nombre+ " es " + nombrePais);
